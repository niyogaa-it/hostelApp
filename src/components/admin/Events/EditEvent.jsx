...
class EditEvent extends Component {
  ...
  getEvent(id) {
    API.get(`/admin/secure/eventDetails/${id}`)
      .then((res) => {
        this.setState({
          eventDetails: res.data.result[0],
        });
      })
      .catch((err) => {
        console.log(err);
  ...
  handleSubmitEvent = (values, actions) => {
    ...
    if (this.state.file) {
      if (this.state.file.size > 1000) {
        ...
        API.post("/admin/secure/update/event", postData)
          .then((res) => {
  ...
  render() {
    ...
    const newInitialValues = Object.assign(initialValues, {
      event_name: eventDetails.event_name ? eventDetails.event_name : "",
      description: eventDetails.des ? eventDetails.des : "",
      start_date: eventDetails.event_start_date ? moment(eventDetails.event_start_date).format("YYYY-MM-DD") : "",
      end_date: eventDetails.event_end_date ? moment(eventDetails.event_end_date).format("YYYY-MM-DD") : "",
    });
