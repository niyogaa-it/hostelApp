...
class OldPlanDatalist extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  componentDidMount() {
    if (
      ...
      API.get(`/admin/secure/old_plan_list`)
        .then((res) => {
          this.setState({
            oldplanList: res.data.result_data,
            oldplanCount: res.data.result_data.length,
            isLoading: false,
          });
        })
        .catch((err) => {
  ...
  handleEditEvent = (event, id) => {
    window.location.href = `/admin/oldplanedit/${id}`;
  };
              ...
              <section className="content-header">
                <div className="row">
                  <h3 className="card-title">
                    ...
                    <span className="sp2"> Old Plan List</span>
                  </h3>
...
export default withRouter(connect(mapStateToProps)(OldPlanDatalist));
