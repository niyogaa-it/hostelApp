...
class NewPlanDatalist extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  componentDidMount() {
    if (
      ...
      API.get(`/admin/secure/new_plan_list`)
        .then((res) => {
          this.setState({
  ...
  handleEditEvent = (event, id) => {
    window.location.href = `/admin/newplanedit/${id}`;
  };
              ...
              <section className="content-header">
                <div className="row">
                  <h3 className="card-title">
                    ...
                    <span className="sp2"> New Plan List</span>
                  </h3>
...
export default withRouter(connect(mapStateToProps)(NewPlanDatalist));
