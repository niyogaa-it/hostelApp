...
class OldPlanEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
        server_error: "",
  ...
  componentDidMount() {
    ...
    API.get(`admin/secure/old_plan_details/${id}`)
      .then((response) => {
  ...
  const payload = {
    ...
    API.post("/admin/secure/edit_old_plan", payload)
      .then((response) => {
        if (response.data.status === 201) {
          swal("Success", response.data.message, "success");
          userLog('Edit Old plan', 'Edit Old plan');
                  ...
                  <Form>
                    <div className="row">
                      <h3 className="card-title">
                        ...
                        <span className="sp2"> Edit Old Plan</span>
                      </h3>
...
export default withRouter(connect(mapStateToProps)(OldPlanEdit));
