          ...
          <section className="content">
            <div className="box">
              <div className="box-body">
                ...
                <BootstrapTable data={this.state.parkinglist}>
                  <TableHeaderColumn
                    isKey
                    dataField="id"
                  ...
                  <TableHeaderColumn dataField="no_of_slot">
                    No of Parking Slot
                  </TableHeaderColumn>
                  <TableHeaderColumn dataField="role" dataFormat={actionFormatter(this)}>Action</TableHeaderColumn>
                </BootstrapTable>
