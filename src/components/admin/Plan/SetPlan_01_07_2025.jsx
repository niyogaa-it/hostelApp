                                ...
                                <td>
                                  <Field
                                    ...
                                    onChange={(e) => {
                                      ...
                                      this.calculateGST("room_rent", e.target.value);
                                    }}
                                  ></Field>
                    ...
                    <div style={{ textAlign: "center" }}>
                          <table className="table">
                             <tbody>
                               ...
                               {Number(this.state.temporarySubTotal) <= 20000 && (
                                <tr>
                                  <td>
                                    <b>Calculate </b>
                                  ...
                                  <td>
                                    <Field
                                      name="gstIncluded"
                                      type="radio"
                                      checked={this.state.gstIncluded === "no"}
                                       onChange={async e => {
                                        this.setState({
                                          gstIncluded: "no",
                                          temporaryFormValues: {
                                    ...
                                    /> {"(Click here when subtotal is <= 20000)"}
                                  </td>
                                </tr>
                              )}
