...
class Reg extends Component {
  ...
  componentDidMount() {
    ...
    API.get(`/admin/un/secure/create/profile/academic_year_list`)
    .then((res) => {
      this.setState({
          ...
          if(res.data.status === 200) {
              ...
              .then((res) => {
                ...
                if (res.data.status === 200) {
                  ...
                  //               swal("Success", "Your Profile created  successfully", "success");
                  //               this.props.history.push("/register");
                  //             }, 2000);      
                  //           }        
                  //       API.post("/admin/un/secure/move_authorized_captured/update", {
                  //         student_id: this.state.studentDetail[0].id,
                  //         student_name: this.state.studentDetail[0].SFname,
                  //         plan_id :this.state.studentDetail[1].id,
                  ...
                  API.post("/admin/un/secure/easebuzz", {
                    ...
                    productinfo: this.state.studentDetail[1].id,
                  ...
                  .then((res) => {
                    //console.log("success", res);
                    //window.location.href = 	'https://testpay.easebuzz.in/pay/'+res.data.data;
                                ...
                                <div className="row">
                                  <div className="col-lg-4 col-md-4 male-panel">
                                    <label htmlFor="ImgBankProf">
                                      Upload Cancel Cheque Or Bank First Page
                                    </label>
                                  </div>
