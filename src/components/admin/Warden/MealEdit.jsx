...
class MealEdit extends Component {
    ...
    getMeal(id) {
        API.get(`/admin/secure/mealDetails/${id}`)
        .then((res) => {
        this.setState({
            mealDetails: res.data.result[0],
        });
        })
        .catch((err) => {
        console.log(err);
    ...
    handleSubmitEvent = (values, { resetForm }) => {
        ...
        API.post("/admin/secure/update/meal", post_data)
            .then((res) => {
                console.log(res)
    ...
    render() {
        ...
        const newInitialValues = Object.assign(initialValues, {
            meal_type: mealDetails.meal_type ? mealDetails.meal_type : "",
            food_preference: mealDetails.food_preference ? mealDetails.food_preference : "",
...
export default withRouter(connect(mapStateToProps)(MealEdit));
