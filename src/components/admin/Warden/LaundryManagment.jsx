...
import ClothsModal from "./ClothsModal";
    ...
    const actionFormat = () => (status, usermangment) => {
      return status === "1" ? (
        ...
        <span className="d-flex">
          ...
          {/*     <Button
            onClick={() => this.click(status, usermangment.id, 4)}
            disabled={this.state.isLoading || status === "4"}
            style={{
              backgroundColor: "#e7e7ff ",
              color: "#883495",
              fontWeight: "bold",
          ...
          <Button
            onClick={() => this.click(status, usermangment.id, 5)}
            disabled={this.state.isLoading || status === "5"}
            style={{
              backgroundColor: "#e8fadf",
              color: "#71dd37",
              fontWeight: "bold",
              ...
              <div className="row">
                <div className="col-lg-12 col-sm-12 col-xs-12">
                  <h1 style={{ color: "#a1acb8" }}>
                    Home / Warden /{" "}
                    <b style={{ color: "#566a7f" }}>Laundry management List</b>
                    <small />
                  </h1>
                </div>
              </div>
