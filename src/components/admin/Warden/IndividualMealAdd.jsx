...
class IndividualMealAdd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            file: "",
    ...
    handleSubmitEvent = (values, { resetForm }) => {
        const post_data = {
            ...
            StudimagepathBase: this.state.file,
        };
        API.post("/admin/secure/individualmeal/add", post_data)
            .then((res) => {
                if (res.data.status == 200) {
                    swal("Success", "Meal Added Successfully", "success");
                    window.location.href = "/admin/individual_meal";
                } else {
...
export default withRouter(connect(mapStateToProps)(IndividualMealAdd));
