...
class Reg extends Component {
  ...
  render() {
    ...
    if (student_details.StudDOB) {
      ...
      this.state.dob =
        rev_dob_list[2] + "-" + rev_dob_list[0] + "-" + rev_dob_list[1];
    }
          ...
          <div className="reg-header">
            ...
            <p>
              <button
                ...
                ref={(node) => {
                  if (node) {
                    node.style.setProperty("margin-left", "15px", "important");
                  }
                }}
                              ...
                              <div className="form-group">
                                <div className="row">
                                  ...
                                  <div className="col-lg-8 col-md-12">
                                    ...
                                    <br />
                                    {student_images.bankProf != "" ? (
                                      <img
                                        src={student_images.bankProf}
                                        alt="hostel"
                                        width="100px"
                                      />
                                    ) : null}
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-8">
                                    ...
                                    >
                                      ...
                                      {/* <option value={this.state.student_details.food_preference}>{this.state.student_details.food_preference}</option> */}
