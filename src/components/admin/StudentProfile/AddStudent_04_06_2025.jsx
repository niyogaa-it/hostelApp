    ...
    if (
      ...
      if (event.target.files[0].size < 5242880) {
        reader.onload = () => {
          ...
          if (fieldName === "ImgBankProf") {
            setFieldTouched("BankimagepathBase");
            setFieldValue("BankimagepathBase", reader.result);
            this.setState({ isValidFile: true });
          }
        };
      } else {
        ...
        if (fieldName === "ImgBankProf") {
          this.setState({
            BankimagepathBaseError: "File size should be less than 5 MB",
            isValidFile: false,
          });
          event.target.value = "";
        }
      ...
      if (fieldName === "ImgBankProf") {
        this.setState({
          BankimagepathBaseError: "File format should be jpg/jpeg/png",
          isValidFile: false,
        });
        event.target.value = "";
      }
                          ...
                          <div className="container-fluid">
                            ...
                            <div className="form">
                                ...
                                <div className="row">
                                      ...
                                      <div className="row">
                                        <div className="col-lg-4">
                                          <label htmlFor="Studimagepath">
                                            Upload Student's Photograph (Max
                                            file size 5 mb) *
                                          </label>
                                        </div>
                                        <div className="col-lg-8">
                                        ...
                                        <div className="col-lg-8">
                                            <div role="group" aria-labelledby="studentType" class="studenttypeclass d-flex">
                                              <label class="mr-4 d-flex align-items-center">
                                                <input name="studentType" type="radio" value="student" class="mr-1" /> Student
                                              </label>
                                              <label class="mr-4 d-flex align-items-center">
                                                <input name="studentType" type="radio" value="working_women" class="mr-1" /> Working Women
                                              </label>
                                            </div>
                                    ...
                                    <div className="form-group">
                                      <div className="row">
                                        <div className="col-lg-4 col-md-4 male-panel">
                                          <label htmlFor="ImgBankProf">
                                            Upload Cancel Cheque Or Bank First
                                            Page
                                          </label>
                                        </div>
                                        <div className="col-lg-8 col-md-12">
                                          ...
                                          {this.state.BankimagepathBaseError !=
                                          "" ? (
                                            <div className="error text-left text-danger">
                                              {
                                                this.state
                                      ...
                                      <div className="row">
                                        <div className="col-lg-4">
                                          <label htmlFor="Localimagepath">
                                            Local Guardian's Photo (Max file
                                            size 5 mb) *
                                          </label>
                                        </div>
                                        <div className="col-lg-8">
                                  ...
                                  <div className="col-lg-12">
                                    <div className="form-heading">
                                      <h3>
                                        List of Male visitors who will be
                                        visiting:
                                      </h3>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-lg-12">
                                    <div className="form-heading">
                                      <h3>
                                        List of Female visitors who will be
                                        visiting:
                                      </h3>
                                    </div>
                                  </div>
                                      ...
                                      <div className="row">
                                        <div className="col-lg-4">
                                          <label htmlFor="transportation">
                                            Do you want to use hostel's
                                            transportation for travelling? *
                                          </label>
                                        </div>
                                        <div className="col-lg-8">
                                          <Field
                            ...
                            <div className="footer">
                              ...
                              <p>
                                ...
                                or the Warden will be considered final in all
                                matters regarding policies and rules and
                                regulations of the hostel.
                              </p>
                              <p>
                                - If admission is granted, we agree to abide by
                                the rules and regulations of the hostel.
                              </p>
                              ...
                              <div style={{ marginBottom: "3%" }}>
                                ...
                                <span>
                                  <b>Note:</b> Filling the form is to furnish
                                  your details and share your preferences.
                                  Admission is not guaranteed until completion
                                  of the process.
                                </span>
                              </div>
                            </div>
