...
handleCustomExportCSV = () => {
  API.get(`/admin/secure/downloadcsvonetime`)
    .then((response) => {
      ...
      //   row.caution_deposit,
      //   row.addmission_fee,
      //   Number((row.addmission_fee * 0.18).toFixed(2)),
      //   row.cultural_fees,
      //   Number((row.cultural_fees * 0.18).toFixed(2)),
      //   row.room_rent,
      //   Number((row.room_rent * 0.18).toFixed(2)),
      //   row.admisson_kit,
      //   Number((row.admisson_kit * 0.18).toFixed(2)),
      //   row.meal,
      //   Number((row.meal * 0.18).toFixed(2)),
      //   row.laundry,
      //   Number((row.laundry * 0.18).toFixed(2)),
      //   row.parking,
      //   Number((row.parking * 0.18).toFixed(2)),
      //   row.transportation,
      //   Number((row.transportation * 0.18).toFixed(2)),
      //   row.monthly_electricity_bill || 0,
      //   Number((row.monthly_electricity_bill * 0.18).toFixed(2)),
      //   row.monthly_water_bill || 0,
      //   Number((row.monthly_water_bill * 0.18).toFixed(2)),
      //   row.other_fees || 0,
      //   Number((row.other_fees * 0.18).toFixed(2)),
      //   row.to_pay,
      //   Number((row.addmission_fee * 0.18).toFixed(2)) + Number((row.cultural_fees * 0.18).toFixed(2)) + Number((row.room_rent * 0.18).toFixed(2)) + Number((row.admisson_kit * 0.18).toFixed(2)) + Number((row.meal * 0.18).toFixed(2)) + Number((row.laundry * 0.18).toFixed(2))  + Number((row.parking * 0.18).toFixed(2)) + Number((row.transportation * 0.18).toFixed(2)) + Number((row.monthly_electricity_bill * 0.18).toFixed(2)) + Number((row.monthly_water_bill * 0.18).toFixed(2)) + Number((row.other_fees * 0.18).toFixed(2)),
